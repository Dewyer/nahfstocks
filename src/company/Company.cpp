...
company::Company::Company(usize id, const String& _name, const String& _sym, f64 _financial_standing, f64 _sector, f64 _leadership_bias,
...
void company::Company::print_debug(std::ostream& os) const noexcept {
	os << "=["<< this->id << "]= " << this->get_name().c_str() << " - [" << this->get_symbol().c_str() << "]" << std::endl;
